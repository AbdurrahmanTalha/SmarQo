                    ...
                    <TableBody className="align-middle">
                        {tableData.map((row) => (
                            ...
                            >
                                    ...
                                    <div>
                                        {
                                            row.liked
                                                ?
                                                <button className="rounded-full py-[7px] flex items-center justify-center text-[16px] font-normal bg-[#1B4830] mr-[192px] h-[31px] w-[160px] px-[49px] mb-[10px] text-white">Liked</button>
                                                :
                                                <button className="rounded-full mb-[10px] py-[7px] flex items-center justify-center text-[16px] font-normal text-[#000] w-[160px] h-[31px] border-2 mr-[192px] border-[#707070] px-[49px]">Disliked</button>
                                ...
                                <TableCell align="right"><span className="lg:md:block hidden border-0">{row.date}</span>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
